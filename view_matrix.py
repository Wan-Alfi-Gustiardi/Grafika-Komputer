...
# Pengaturan OpenGL
# load image
image = Image.open("textures/crate.jpeg")
...
projection = pyrr.matrix44.create_perspective_projection_matrix(45, 1280/720, 0.1, 100) # Perspektif proyeksi
translation = pyrr.matrix44.create_from_translation(pyrr.Vector3([0, 0, 0])) # Transformasi model
